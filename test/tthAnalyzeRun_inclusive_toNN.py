...
from tthAnalysis.HiggsToTauTau.configs.analyzeConfig_inclusive_toNN import analyzeConfig_inclusive_toNN
from tthAnalysis.HiggsToTauTau.jobTools import query_yes_no
from tthAnalysis.HiggsToTauTau.analysisSettings import systematics, get_lumi
from tthAnalysis.HiggsToTauTau.runConfig import tthAnalyzeParser, filter_samples

# E.g.: ./tthAnalyzeRun_inclusive_toNN.py -v inclusive_toNN_2017Dec10 -m default -e 2017
...
if mode == "default":
  ...
  if era == "2016":
    ...
    hadTau_selection         = "dR03mvaLoose" # "dR03mvaMedium"
    hadTau_selection_relaxed = "dR03mvaVLoose" #"dR03mvaLoose" # "dR03mvaVVLoose"
  elif era == "2018":
    raise ValueError("Implement me!")
  else:
    raise ValueError("Invalid era: %s" % era)
...
if __name__ == '__main__':
  ...
  analysis = analyzeConfig_inclusive_toNN(
    configDir = os.path.join("/home",       getpass.getuser(), "ttHAnalysis", era, version),
    outputDir = os.path.join("/hdfs/local", getpass.getuser(), "ttHAnalysis", era, version),
    executable_analyze                    = "analyze_inclusive_toNN",
    cfgFile_analyze                       = "analyze_inclusive_toNN_cfg.py",
    samples                               = samples,
