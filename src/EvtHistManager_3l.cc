...
EvtHistManager_3l::bookHistograms(TFileDirectory & dir)
{
  ...
  //histogram_memOutput_logWeight_ttH_     = book1D(dir, "memOutput_logWeight_ttH",     "memOutput_logWeight_ttH",     1, -20., +20.);
  //histogram_memOutput_logWeight_tt_      = book1D(dir, "memOutput_logWeight_tt",      "memOutput_logWeight_tt",      1, -20., +20.);
  //histogram_memOutput_LR_                = book1D(dir, "memOutput_LR",                "memOutput_LR",                 4,   0.,   1.);
  //histogram_mem_logCPUTime_              = book1D(dir, "mem_logCPUTime",              "mem_logCPUTime",              4, -20., +20.);
  //histogram_mem_logRealTime_             = book1D(dir, "mem_logRealTime",             "mem_logRealTime",             4, -20., +20.);
  histogram_output_NN_3l_ttH_tH_3cat_v8_ = book1D(dir, "output_NN_3l_ttH_tH_3cat_v8",             "output_NN_3l_ttH_tH_3cat_v8",             100, 0., 1.);
  histogram_output_NN_3l_ttH_tH_BKG_2_2_2_     = book1D(dir, "output_NN_3l_ttH_tH_BKG_2_2_2",     "output_NN_3l_ttH_tH_BKG_2_2_2",           100, 0., 1.);
  histogram_output_NN_3l_ttH_tH_BKG_1p5_1_1p5_ = book1D(dir, "output_NN_3l_ttH_tH_BKG_1p5_1_1p5", "output_NN_3l_ttH_tH_BKG_1p5_1_1p5",       100, 0., 1.);
  histogram_output_NN_3l_ttH_tH_BKG_1p5_1p5_1_ = book1D(dir, "output_NN_3l_ttH_tH_BKG_1p5_1p5_1", "output_NN_3l_ttH_tH_BKG_1p5_1p5_1",       100, 0., 1.);
  histogram_output_NN_3l_ttH_tH_BKG_1p5_1_1_   = book1D(dir, "output_NN_3l_ttH_tH_BKG_1p5_1_1",   "output_NN_3l_ttH_tH_BKG_1p5_1_1",         100, 0., 1.);
                                  ...
                                  double evtWeight)
{
  ...
  fillWithOverFlow(histogram_output_NN_3l_ttH_tH_BKG_2_2_2_,      output_NN_3l_ttH_tH_BKG_2_2_2,      evtWeight, evtWeightErr);
  fillWithOverFlow(histogram_output_NN_3l_ttH_tH_BKG_1p5_1_1p5_,  output_NN_3l_ttH_tH_BKG_1p5_1_1p5,  evtWeight, evtWeightErr);
  fillWithOverFlow(histogram_output_NN_3l_ttH_tH_BKG_1p5_1p5_1_,  output_NN_3l_ttH_tH_BKG_1p5_1p5_1,  evtWeight, evtWeightErr);
  fillWithOverFlow(histogram_output_NN_3l_ttH_tH_BKG_1p5_1_1_,    output_NN_3l_ttH_tH_BKG_1p5_1_1,    evtWeight, evtWeightErr);
