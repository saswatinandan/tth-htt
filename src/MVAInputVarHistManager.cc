  ...
  : HistManagerBase(cfg)
{
  ...
  binningOptions_["res_HTT"]                    = new binningOptionType("res_HTT",               30,  0.,    1.);
  ...
  binningOptions_["lep_pt"]                     = new binningOptionType("lep_pt",                     40,  0.,  300.);
  ...
  binningOptions_["lep1_eta"]                   = new binningOptionType("lep1_eta",                   50, -2.5,  +2.5);
  binningOptions_["lep1_phi"]                   = new binningOptionType("lep1_phi",                   50, -3.15,  +3.15);
  ...
  binningOptions_["lep1_conePt"]                = new binningOptionType("lep1_conePt",                40,  0.,  300.);
  binningOptions_["lep1_conept"]                = new binningOptionType("lep1_conept",                40,  0.,  300.);
  binningOptions_["lep1_pt"]                    = new binningOptionType("lep1_pt",                    40,  0.,  300.);
  ...
  binningOptions_["lep2_eta"]                   = new binningOptionType("lep2_eta",                   50, -2.5,  +2.5);
  binningOptions_["lep2_phi"]                   = new binningOptionType("lep2_phi",                   50, -3.15,  +3.15);
  binningOptions_["lep2_conePt"]                = new binningOptionType("lep2_conePt",                40,  0.,  300.);
  binningOptions_["lep2_conept"]                = new binningOptionType("lep2_conept",                40,  0.,  300.);
  binningOptions_["lep2_pt"]                    = new binningOptionType("lep2_pt",                    40,  0.,  300.);
  ...
  binningOptions_["lep3_conePt"]                = new binningOptionType("lep3_conePt",                40,  0.,  300.);
  binningOptions_["lep3_conept"]                = new binningOptionType("lep3_conept",                40,  0.,  300.);
  binningOptions_["lep3_pt"]                    = new binningOptionType("lep3_pt",                    40,  0.,  300.);
  binningOptions_["lep3_eta"]                   = new binningOptionType("lep3_eta",                   50, -2.5,  +2.5);
  binningOptions_["lep3_phi"]                   = new binningOptionType("lep3_phi",                   50, -3.15,  +3.15);

  binningOptions_["jet1_pt"]                    = new binningOptionType("jet1_pt",                    40,  0.,  300.);
  binningOptions_["jet1_eta"]                   = new binningOptionType("jet1_eta",                   50, -2.5,  +2.5);
  binningOptions_["jet1_phi"]                   = new binningOptionType("jet1_phi",                   50, -3.15,  +3.15);
  binningOptions_["jet2_pt"]                    = new binningOptionType("jet2_pt",                    40,  0.,  300.);
  binningOptions_["jet2_eta"]                   = new binningOptionType("jet2_eta",                   50, -2.5,  +2.5);
  binningOptions_["jet2_phi"]                   = new binningOptionType("jet2_phi",                   50, -3.15,  +3.15);
  binningOptions_["jet3_pt"]                    = new binningOptionType("jet3_pt",                    40,  0.,  300.);
  binningOptions_["jet3_eta"]                   = new binningOptionType("jet3_eta",                   50, -2.5,  +2.5);
  binningOptions_["jet3_phi"]                   = new binningOptionType("jet3_phi",                   50, -3.15,  +3.15);
  binningOptions_["jet4_pt"]                    = new binningOptionType("jet4_pt",                    40,  0.,  300.);
  binningOptions_["jet4_eta"]                   = new binningOptionType("jet4_eta",                   50, -2.5,  +2.5);
  binningOptions_["jet4_phi"]                   = new binningOptionType("jet4_phi",                   50, -3.15,  +3.15);
  binningOptions_["leadFwdJet_pt"]              = new binningOptionType("leadFwdJet_pt",              40,  0.,  300.);
  binningOptions_["jetForward1_pt"]             = new binningOptionType("jetForward1_pt",             40,  0.,  300.);

  binningOptions_["leadFwdJet_eta"]             = new binningOptionType("leadFwdJet_eta",             50, 0.5,  +2.5);
  binningOptions_["min_Deta_leadfwdJet_jet"]    = new binningOptionType("min_Deta_leadfwdJet_jet",    50, 0.0,  +5.0);
  ...
  binningOptions_["massL3"]                     = new binningOptionType("massL3",                     80,  0.,  600.);
  binningOptions_["mT_lep"]                     = new binningOptionType("mT_lep",                     40,  0.,  200.);
  binningOptions_["mT_lep1"]                    = new binningOptionType("mT_lep1",                    40,  0.,  400.);
  binningOptions_["mT_lep2"]                    = new binningOptionType("mT_lep2",                    40,  0.,  300.);
  binningOptions_["mT_lep3"]                    = new binningOptionType("mT_lep3",                    40,  0.,  200.);
  binningOptions_["mT_lep4"]                    = new binningOptionType("mT_lep4",                    40,  0.,  200.);

  binningOptions_["lep1_mT"]                    = new binningOptionType("lep1_mT",                    40,  0.,  400.);
  binningOptions_["lep2_mT"]                    = new binningOptionType("lep2_mT",                    40,  0.,  300.);
  binningOptions_["lep3_mT"]                    = new binningOptionType("lep3_mT",                    40,  0.,  200.);
  binningOptions_["lep4_mT"]                    = new binningOptionType("lep4_mT",                    40,  0.,  200.);

  binningOptions_["eta_LepLep_los"]             = new binningOptionType("eta_LepLep_los",             40,  0.,  2.8);
  binningOptions_["min_dr_Lep"]                 = new binningOptionType("min_dr_Lep",                 40,  0.,  2.8);
  ...
  binningOptions_["nJet"]                       = new binningOptionType("nJet",                       11, -0.5, +10.5);
  ...
  binningOptions_["sum_Lep_charge"]             = new binningOptionType("sum_Lep_charge",             7, -3.5, +3.5);
  binningOptions_["nElectron"]                  = new binningOptionType("nElectron",                  4, -0.5, +3.5);
  binningOptions_["sum_lep_charge"]             = new binningOptionType("sum_lep_charge",             7, -3.5, +3.5);
  binningOptions_["has_SFOS"]                   = new binningOptionType("has_SFOS",                   2, -0.5, +1.5);
  binningOptions_["ptmiss"]                     = new binningOptionType("ptmiss",                     40,  0.,  200.);
  binningOptions_["met_LD"]                     = new binningOptionType("met_LD",                     40,  0.,  300.);
  ...
  binningOptions_["res-HTT_CSVsort4rd"]         = new binningOptionType("res-HTT_CSVsort4rd",         50, 0.,   +1.);
  binningOptions_["HadTop_pt_CSVsort4rd"]       = new binningOptionType("HadTop_pt_CSVsort4rd",       30,  0.,  500.);
