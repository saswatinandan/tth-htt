#include "tthAnalysis/HiggsToTauTau/interface/EvtHistManager_inclusive_toNN.h"

#include "tthAnalysis/HiggsToTauTau/interface/histogramAuxFunctions.h" // fillWithOverFlow(), fillWithOverFlow2d()

EvtHistManager_inclusive_toNN::EvtHistManager_inclusive_toNN(const edm::ParameterSet& cfg)
  : HistManagerBase(cfg)
{}

void
EvtHistManager_inclusive_toNN::bookHistograms(TFileDirectory & dir)
{
...
void
EvtHistManager_inclusive_toNN::fillHistograms(int numElectrons,
                                       int numMuons,
                                       int numHadTaus,
                                       int numJets,
                                       int numBJets_loose,
