...
HadTopTagger_semi_boosted_AK8::HadTopTagger_semi_boosted_AK8(void)
  : mva_xgb_HTT_CSVsort4rd_AK8_(nullptr)
  , mva_xgb_HTT_CSVsort4rd_AK8_withKinFit_(nullptr)
{

  //std::string mvaFileNameHTT_CSVsort4rd = "tthAnalysis/HiggsToTauTau/data/hadTopTagger_2018/HTT_HadTopTagger_2017_boosted_final_XGB_ntrees_2500_deph_4_lr_0o03_btagSort3rd_nvar13_cat_2.pkl";
  //std::string mvaFileNameHTT_CSVsort4rd_withKinFit = "tthAnalysis/HiggsToTauTau/data/hadTopTagger_2018/HTT_HadTopTagger_2017_boosted_final_XGB_ntrees_2500_deph_4_lr_0o03_btagSort3rd_nvar16_cat_2_withKinFit_sel_5.pkl";

  std::string mvaFileNameHTT_CSVsort4rd = "tthAnalysis/HiggsToTauTau/data/hadTopTagger_2018/no_mass_cut_on_new/HTT_HadTopTagger_2017_final_nomasscut_AK8_XGB_ntrees_2500_deph_4_lr_0o03_btagSort3rd_nvar12_cat_2_AK8.pkl";
  std::string mvaFileNameHTT_CSVsort4rd_withKinFit = "tthAnalysis/HiggsToTauTau/data/hadTopTagger_2018/no_mass_cut_on_new/HTT_HadTopTagger_2017_final_nomasscut_AK8_XGB_ntrees_2500_deph_4_lr_0o03_btagSort3rd_nvar15_cat_2_withKinFit_sel_9.pkl";
  ...
  mva_xgb_HTT_CSVsort4rd_AK8_ = new XGBInterface(
    mvaFileNameHTT_CSVsort4rd, mvaInputsHTT_AK8Sort
  );
  ...
  mva_xgb_HTT_CSVsort4rd_AK8_withKinFit_ = new XGBInterface(
    mvaFileNameHTT_CSVsort4rd_withKinFit, mvaInputsHTT_AK8Sort_withKinFit
  );
...
{
  //delete kinFit_;
  delete mva_xgb_HTT_CSVsort4rd_AK8_;
  delete mva_xgb_HTT_CSVsort4rd_AK8_withKinFit_;
}
...
)
{
  ...
  const double HTT_CSVsort4rd = (*mva_xgb_HTT_CSVsort4rd_AK8_)(mvaInputsHTT_AK8);
  result[kXGB_semi_boosted_AK8_no_kinFit] = HTT_CSVsort4rd;
  //std::cout << "semi-boosted HTT_CSVsort4rd " << HTT_CSVsort4rd << jet_ptrsAK12.tau2()/jet_ptrsAK12.tau1() << std::endl;
  ...
  const double HTT_CSVsort4rd_withKinFit = (*mva_xgb_HTT_CSVsort4rd_AK8_withKinFit_)(mvaInputsHTT_AK8_withKinFit);
  result[kXGB_semi_boosted_with_kinFit] = HTT_CSVsort4rd_withKinFit;
  //std::cout << "semi-boosted HTT_CSVsort4rd_withKinFit " << HTT_CSVsort4rd_withKinFit << kinFit_->nll() << std::endl;
  */
  result[kXGB_semi_boosted_AK8_with_kinFit] = 0.;
