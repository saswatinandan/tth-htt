#ifndef tthAnalysis_HiggsToTauTau_EvtHistManager_inclusive_toNN_h
#define tthAnalysis_HiggsToTauTau_EvtHistManager_inclusive_toNN_h

/** \class EvtHistManager_inclusive_toNN
 *
 * Book and fill histograms for event-level quantities in ttH, H->tautau analysis
 * in inclusive_toNN category
 *
 */
...
{
public:
  EvtHistManager_inclusive_toNN(const edm::ParameterSet & cfg);
  ~EvtHistManager_inclusive_toNN() {}
