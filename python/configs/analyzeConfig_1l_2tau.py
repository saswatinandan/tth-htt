...
class analyzeConfig_1l_2tau(analyzeConfig):
  ...
  def create(self):
          ...
          for hadTau_charge_selection in self.hadTau_charge_selections:
            ...
            for central_or_shift_or_dummy in central_or_shifts_extended:
              ...
              for process_name_or_dummy in process_name_extended:
                ...
                key_dir = getKey(process_name_or_dummy, lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection, central_or_shift_or_dummy)
      ...
      for lepton_and_hadTau_frWeight in self.lepton_and_hadTau_frWeights:
        ...
        for hadTau_charge_selection in self.hadTau_charge_selections:
          ...
          for sample_name, sample_info in self.samples.items():
            ...
            for central_or_shift in self.central_or_shifts:
              ...
              for jobId in inputFileList.keys():
                ...
                key_hadd_stage1_dir = getKey(process_name, lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
                hadd_stage1_job_tuple = (process_name, lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
            ...
            if not is_mc:
              key_hadd_stage1_job = getKey(process_name, lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
              key_hadd_stage1_5_job = getKey(lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
              if not key_hadd_stage1_5_job in self.inputFiles_hadd_stage1_5:
                self.inputFiles_hadd_stage1_5[key_hadd_stage1_5_job] = []
          ...
          self.jobOptions_addBackgrounds_sum[key_addBackgrounds_job_Convs] = {
            ...
            'logFile' : os.path.join(self.dirs[key_addBackgrounds_dir][DKEY_LOGS], "addBackgrounds_%s_Convs_%s_%s.log" % addBackgrounds_job_Convs_tuple),
            'categories' : [ getHistogramDir(lepton_and_hadTau_selection, lepton_and_hadTau_frWeight, hadTau_charge_selection) ],
            'processes_input' : processes_input,
          ...
          key_hadd_stage1_5_job = getKey(lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
          key_hadd_stage2_dir = getKey("hadd", lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
          hadd_stage2_job_tuple = (lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
    ...
    for hadTau_charge_selection in self.hadTau_charge_selections:
      ...
      #key_addFakes_job = getKey("data_fakes", hadTau_charge_selection) # FIXME
    ...
    for histogramToFit in self.histograms_to_fit:
      ...
      for hadTau_charge_selection in self.hadTau_charge_selections:
        ...
        for lepton_and_hadTau_type in [ 'e', 'm', 't' ]:
          ...
          key_addBackgrounds_job_fakes = getKey("fakes_mc", lepton_and_hadTau_selection_and_frWeight, hadTau_charge_selection)
