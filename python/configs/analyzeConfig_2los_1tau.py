...
def getHistogramDirList(lepton_selection, hadTau_selection, lepton_and_hadTau_frWeight, subcategories):
  histogramDirListL = []
...
class analyzeConfig_2los_1tau(analyzeConfig):
  ...
  def createCfg_analyze(self, jobOptions, sample_info, lepton_and_hadTau_selection):
    ...
    histogramDir = getHistogramDirList(
      lepton_and_hadTau_selection, jobOptions['hadTauSelection'], lepton_and_hadTau_frWeight, [self.channel]
    )[0]
  ...
  def create(self):
              ...
              for genMatch_category in genMatch_categories:
                ...
                if processes_input:
                  ...
                  self.jobOptions_addBackgrounds[key_addBackgrounds_job] = {
                    ...
                    'categories' : getHistogramDirList(lepton_selection, hadTau_selection, lepton_and_hadTau_frWeight, self.subcategories) ,
    ...
    if self.applyFakeRateWeights == "2lepton" or self.applyFakeRateWeights == "3L" or self.applyFakeRateWeights == "1tau":
      ...
      category_sideband = getHistogramDirList("Fakeable", "Fakeable", "enabled", self.subcategories)
    else:
    ...
    self.jobOptions_addFakes[key_addFakes_job] = {
      ...
      'category_signal' : getHistogramDirList("Tight", "Tight", "", self.subcategories), #"2los_1tau_Tight",
